...
public class SimpleSwap implements ModInitializer, ClientModInitializer {
    ...
    public static final Identifier SIMPLE_SWAP_ICON = Identifier.of("simpleswap", "textures/gui/sprites/blockswap.png");

    @Override
    public void onInitialize() {
    }

    public static void onClientBlockBroken(ClientWorld world, ClientPlayerEntity player, BlockPos pos, BlockState state) {
        ...
        ClientTickEvents.END_WORLD_TICK.register(world -> {
            ...
            if (client.player != null && client.interactionManager != null) {
                ...
                iterator.forEachRemaining(target -> {
                    ...
                    client.player.playSound(SoundEvents.ENTITY_ITEM_PICKUP, SoundCategory.BLOCKS, 0.4f, 0.6f);
